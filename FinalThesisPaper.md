...
![Left: High twisting moment. Middle: Stiffening by triangulation. Right: Torsion free alignment.[@zadravec2010designing]](MT_JPG/Figure_10.jpg){#fig:Figure_10}
...
![Surface tangency of the mesh having double curvature $\mathbb{R}^{3}_{3}$  by computing the minimum $e_{1}$ and maximum $e_{2}$ *principle directions* in red and blue.](MT_JPG/Figure_14.jpg){#fig:Figure_14}
...
![The resulting candidate PQ mesh have a semi regular valence.](MT_JPG/Figure_18.jpg){#fig:Figure_18}
...
![Left: Subdivided mesh using catmull-clark algorithm and singularities in color. Right: Pulling the subdivided mesh to the input surface.](MT_JPG/Figure_34.jpg){#fig:Figure_34}
...
![Graph showing the mean apect ratio in $cm$ vs. the mean of planarity in radians for the four meshes $\mathbb{R}^3_{i}$.](MT_JPG/Figure_37.jpg){#fig:Figure_37}

![Graph showing the MAD of the warping height in $cm$ over the MAD of areas in $cm^2$ for the four meshes $\mathbb{R}^3_{i}$.](MT_JPG/Figure_38.jpg){#fig:Figure_38}
...
![Appedix image 1](MT_JPG/Figure_39.jpg)

![Appedix image 1](MT_JPG/Figure_40.jpg)
