...
![Graph showing the difference between the elements areas and the number of panels for each of the first mesh $\mathbb{R}^3_{3}$ generated by the three different techniques](MT_JPG/Areas3.jpg){#fig:graph3}
